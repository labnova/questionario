...
function calcolaMedia($pun) {
	...
	$domanda= "SELECT domanda.domanda, domanda.rispostaEsatta, 
								   risposta.risposta1, 
								   risposta.risposta2, 
								   risposta.risposta3, 
								   risposta.spiegazione1,
								   risposta.spiegazione2, 
								   risposta.spiegazione3 ";



	$domanda .= " FROM domanda,risposta ";  

	$domanda .= " WHERE domanda.idMeeting='1'  AND domanda.idDomanda=risposta.idDomanda   ";  

	$domanda .= " ORDER BY rand() ";  	

	$risultato= mysqli_query($conn, $domanda);



	if(!$risultato) {

		die("problemi nel trovare la domanda" .mysqli_error($domanda));
	} 
...
<section>
	...
	<div class='domanda'>1. <?php var_dump($row); $row['domanda'] ?></div>
	<ul>
    	<li><input type='radio' name='domanda1' value='risposta1' /><label><? $row['rispostaEsatta'] ?></label></li><br/>
		<li><input type='radio' name='domanda1' value='risposta2' /><label><? $row['risposta1'] ?></label></li><br/>
		<li><input type='radio' name='domanda1' value='risposta3' /><label><? $row['risposta2'] ?></label></li><br/>
		<li><input type='radio' name='domanda1' value='risposta4' /><label><? $row['risposta3'] ?></label></li><br/>
</ul>
...
$voto="";
	...
	switch ($punteggio) {
			...
			echo "<p>$voto</p>";
			echo "<p>Il tuo punteggio &egrave; </p><div class='numero'> " .$media."/60</div><br/>";
			echo "<p>Hai superato la prova, bravo!<br/>Inserisci il tuo nome, cognome e la mail per ricevere l'attestato.  ";
			echo "<br/><br/>";
			...
			echo "<p>$voto</p>";
			echo "<p>Il tuo punteggio &egrave;</p><div class='numero'>  " .$media."/60</div><br/>";
			echo "<p>Sei stato fantastico!<br/>Inserisci il tuo nome, cognome e la mail per ricevere l'attestato.";
			echo "<br/><br/>";
			echo "<input type='text' required='true' name='nome' placeholder='inserisci il nome' /><br/>";
			echo "<input type='text' required='true' name='cognome' placeholder='inserisci il cognome' /><br/>";
			echo "<input type='email' required='true' name='mail' placeholder='inserisci la mail' /><br/>";
